"""
Django settings for ecowaste project.
...
SECRET_KEY = 'django-insecure-n$(u5%mg(4%i0y#h@kxoxa8ah3cm11=!p!*xhzz54)=*$fho-4'
...
WSGI_APPLICATION = 'ecowaste.wsgi.application'
